...
function Hero() {
  ...
  return (
    <header ref={heroRef} className={`hero ${isVisible ? 'hero--visible' : ''}`} id="hero">
      ...
      <div className="hero__content">
        ...
        <p className="hero__message">
          Para la mujer que nos dio la vida, que nos enseñó a amar y a soñar.
          Este álbum es un pequeño reflejo del inmenso amor que sentimos por ti.
        </p>
